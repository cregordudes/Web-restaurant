...
<head>
   ...
   <title>Меню - Напитки| Мама Мия</title>
</head>
      ...
      <section id="best-dishes" class="menu">
         <div class="container">
            <div class="menu-title d-flex">
               <h2 class="menu-name"><i>Пиццы</i></h2>
            </div>
            <div class="dishes d-flex">

               <?php
               $products = mysqli_query($connect, "SELECT * FROM `catalog` WHERE `category` = 5 ");
               $products = mysqli_fetch_all($products);
               foreach ($products as $product) {
                  $id = $product[0];
               ?>
                  <div class="product">
                     <img src="/img/drinks/<?= $product[2] ?>" alt="">
