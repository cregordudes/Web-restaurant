...
<head>
   ...
   <title>Меню - Закуски| Мама Мия</title>
</head>
      ...
      <section id="best-dishes" class="menu">
         <div class="container">
            <div class="menu-title d-flex">
               <h2 class="menu-name"><i>Закуски</i></h2>
            </div>
            <div class="dishes d-flex">

               <?php
               $products = mysqli_query($connect, "SELECT * FROM `catalog` WHERE `category` = 3 ");
               $products = mysqli_fetch_all($products);
               foreach ($products as $product) {
                  $id = $product[0];
               ?>
                  <div class="product">
                     <img src="/img/snacks/<?= $product[2] ?>" alt="">
